-- =========================================================
-- Outbox transacional. O evento eh gravado na MESMA transacao da mudanca
-- de estado: sai se, e somente se, o estado foi commitado.
--
-- Quem publica eh o Debezium, lendo o WAL. Esta tabela nao eh fila de
...
CREATE PUBLICATION debezium_inventory_outbox FOR TABLE outbox;
