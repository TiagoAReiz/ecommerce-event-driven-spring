...
/**
 * Dialogo simples em overlay. A area de pedidos/avaliacoes precisa de
 * confirmacao antes de acoes irreversiveis (cancelar, confirmar entrega,
 * avaliar) e o kit de UI compartilhado nao tem um modal pronto.
 */
